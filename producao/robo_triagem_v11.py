...
import robo_sigs_extrai_incidentes_v16 as EX
...
def redireciona_incidente(driver, id_incidente, grupo_destino, expande):
    ...
    IS.insere_texto(IS.retorna_objetos(driver, 'id', 'X249'), 'CORRIGIR DIRECIONAMENTO')#insere o texto "Corrigir Direcionamento"
    IS.insere_texto(IS.retorna_objetos(driver, 'id', 'X260View'), 'TESTE ROBÔ SIGS')#insere a justificativa do redirecionamento
    driver.switch_to.default_content()#retorna ao content default
...
def main():
    ...
    classifica()
    driver = inicia_redirecionamento()
    print("=======================\nFim da execução\n=======================")
    driver.quit()
